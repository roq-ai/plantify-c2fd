...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'plant-specialist', 'customer-service-representative', 'marketing-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Campaign', path: '/campaigns', entity: 'campaign', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    ...
    { name: 'Plant', path: '/plants', entity: 'plant', service: AccessServiceEnum.PROJECT, icon: FiFeather },
